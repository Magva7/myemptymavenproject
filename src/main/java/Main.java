...
//                System.out.println("Аргументы argSum: " + argSum);
 ...
 /** Объявляем новый метод, который принимает снаружи из метода main переменные, в argSum уже лежит сумма аргументов,
  * в countArg их количество,а сам метод делит одну переменную на другую и возвращает отдает наружу результат*/
